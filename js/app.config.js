app.config = {
	...
	envs	: {
		...
		beta: {		// tests local network
			...
			sisbot_url  	: 'http://192.168.1.140:3002', //talking to sisbot    //  ... or just put your URL in here '192.168.XX.XXX:3002' << for local Dev Env --insert your ip address + 3000
			port			: 3001,
			show_tg			: true
		},
		training: {
		...
		wc_test: {
			...
			api_url			: 'http://dev.webcenter.sisyphus-industries.com/',
			web_url			: 'http://dev.webcenter.sisyphus-industries.com/',
			sisbot_url  	: 'http://192.168.1.140:3002', //talking to sisbot
			port			: 3001,
		}
	},
