app.config = {
	...
	envs	: {
		...
		beta: {		// tests local network
			...
			sisbot_url  : 'http://192.168.1.121:3002', //talking to sisbot    //  ... or just put your URL in here '192.168.XX.XXX:3002' << for local Dev Env --insert your ip address + 3000
			port		: 3001,
			show_tg		: true
		},
		training: {
		...
		matt: {
			...
			api_url			: 'http://localhost:3333/', // add entry in your computers /etc/hosts mapped to your bot's IP address
			web_url			: 'http://localhost:3333/', //web_center url	***Change to this for Rails web_center= http://localhost:3333/  (aka rails s) //  10.0.0.3	beta_bot.local
			sisbot_url  : 'http://192.168.86.26:3002', // 26: Mini, 33: Wall    //  ... or just put your URL in here '192.168.XX.XXX:3002' << for local Dev Env --insert your ip address + 3000
			port		: 3001,
		},
		sisbot: {
